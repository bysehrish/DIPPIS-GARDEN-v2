        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 xl:px-12">
          <div className="flex items-center justify-between h-16 sm:h-20 gap-2 sm:gap-4">
            ...
            <div className="flex items-center shrink-0">
              <Link to="/" className="flex items-center gap-1.5 sm:gap-2.5 md:gap-3 group shrink-0">
                <img
                  src={logoImg}
                ...
                />
                <span className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl font-bold font-serif tracking-wider text-black leading-none whitespace-nowrap">
                  DIPPIS GARDENS
                </span>
              </Link>
            </div>
